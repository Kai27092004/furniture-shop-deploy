...
import { ChevronDown, ZoomIn, ZoomOut, Filter, Search } from 'lucide-react';
        ...
        const loadData = async () => {
            try {
                ...
                const [productsResponse, categoriesResponse] = await Promise.all([
                    fetchProducts({ search: searchQueryFromUrl }),
                    fetchCategories()
                ]);
                ...
                // Đặt searchQuery từ URL nếu có
                if (searchQueryFromUrl) {
                    setSearchQuery(searchQueryFromUrl);
                    // Scroll đến phần filter sau khi load xong
                    setTimeout(() => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div ref={filterSectionRef} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <input
                                    ...
                                    className="pl-10 pr-4 py-2 text-sm border rounded-md focus:outline-none focus:ring-2 w-64"
                                />
                            </div>
                        </div>
